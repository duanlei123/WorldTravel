...
class Spots(models.Model):
    ...
    旅游景区
    """
    name = models.CharField(max_length=30, verbose_name="景区名称")
    content = UEditorField(verbose_name="景区内容", width=600, height=300, imagePath='Scenic/ueditor/', filePath='Scenic/ueditor/', default='')
    ...
    classification = models.CharField(max_length=10, choices=(('natural', '景区'), ('leisure', '休闲')), default='natural', verbose_name='分类')
